...
const u16 gPalMainMenuBG[] = INCBIN_U16("graphics/bg.pal");
const u16 gPalMainMenuNoSel[] = INCBIN_U16("graphics/no_sel.pal");
const u16 gPalMainMenuSel[] = INCBIN_U16("graphics/sel.pal");
