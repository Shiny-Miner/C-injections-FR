...
static const u32 sConfirmButton_Tilemap[] = INCBIN_U32("graphics/party_menu_confirm_button.bin");
static const u32 sCancelButton_Tilemap[] = INCBIN_U32("graphics/party_menu_cancel_button.bin");
